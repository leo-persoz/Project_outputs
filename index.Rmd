...
htmltools::tags$iframe(
  src = here("C:/Kenya_anaylsis_Rproject/Project_outputs/outputs_touse/tables/final_num_vars_table.html"),
  width = "100%",
  height = "250px",
  style = "border:none;"
  )
...
htmltools::tags$iframe(
  src = here("C:/Kenya_anaylsis_Rproject/Project_outputs/outputs_touse/tables/final_cat_var_table.html"),
  width = "100%",
  height = "600px",
  style = "border:none;"
  )
